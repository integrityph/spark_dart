...
class KnownRegex extends $pb.ProtobufEnum {
  static const KnownRegex UNKNOWN =
      KnownRegex._(0, _omitEnumNames ? '' : 'UNKNOWN');

  /// HTTP header name as defined by RFC 7230.
  static const KnownRegex HTTP_HEADER_NAME =
      KnownRegex._(1, _omitEnumNames ? '' : 'HTTP_HEADER_NAME');

  /// HTTP header value as defined by RFC 7230.
  static const KnownRegex HTTP_HEADER_VALUE =
      KnownRegex._(2, _omitEnumNames ? '' : 'HTTP_HEADER_VALUE');
